...
public enum QuestTemplate {
    ...
    A_FAT_GOBLIN_FIRST(Quest.A_FAT_GOBLIN, QuestPart.FIRST, MonsterGroup.GOBLIN_ARCHER, null, 1, MonsterTrait.WILDERNESS, MonsterTrait.CIVILIZED),
    A_FAT_GOBLIN_SECOND(Quest.A_FAT_GOBLIN, QuestPart.SECOND, MonsterGroup.GOBLIN_ARCHER, MonsterGroup.CAVE_SPIDER, 1, MonsterTrait.CAVE, MonsterTrait.BUILDING);
    ...
    private QuestTemplate(Quest quest, QuestPart questPart, MonsterGroup requiredGroup1, MonsterGroup requiredGroup2, int openGroupCount, MonsterTrait monsterTrait1, MonsterTrait monsterTrait2) {
        this.quest = quest;
